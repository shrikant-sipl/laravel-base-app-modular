                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        @if(isset($customer) && count($customer) > 0)
                            {!! Form::model($customer, ['url' => URL::route('manage-customer.update', $customer->id), 'method' => 'PUT', 'id' => 'customer_form', 'data-parsley-validate' => true]) !!}
                        @else
                             {!! Form::open(['url' => URL::route('manage-customer.store'), 'method' => 'POST', 'id' => 'customer_form', 'data-parsley-validate' => true]) !!}
                        @endif
